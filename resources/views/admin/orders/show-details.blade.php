            ...
            <div class="col-lg-10">
                <div class="card">
                    <div class="card-header">
                        <a href="{{route('orders.index')}}" class="btn btn-primary">{{__('admin/app.back')}}</a>
                    </div>
                    <div class="card-body">
                        <div class="row mb-3">
                            <div class="col-sm-3">
                        ...
                        <div class="row mb-3">
                            <div class="col-sm-3">
                                <h6 class="mb-0">{{__('admin/app.type')}}</h6>
                            </div>
                            <div class="col-sm-9 text-secondary">
                                <input type="text" class="form-control"  disabled readonly value="{{$order->type}}" />
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9 text-secondary">
                                <textarea class="form-control" disabled readonly>{{$order->msg}}</textarea>
                            </div>
                        </div>
                        <hr>
