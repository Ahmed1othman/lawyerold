            ...
            <div class="col-lg-10">
                <div class="card">
                    <div class="card-header">
                        <a href="{{route('contact-us.index')}}" class="btn btn-primary">{{__('admin/app.back')}}</a>
                    </div>
                    <div class="card-body">
                        <div class="row mb-3">
                            <div class="col-sm-3">
                            ...
                            <div class="col-sm-9 text-secondary">
                                <input type="text" class="form-control"  disabled readonly value="{{$contactUs->name}}" />
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-sm-3">
                            ...
                            <div class="col-sm-9 text-secondary">
                                <input type="text" class="form-control"  disabled readonly value="{{$contactUs->email}}" />
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-sm-3">
                            ...
                            <div class="col-sm-9 text-secondary">
                                <input type="text" class="form-control"  disabled readonly value="{{$contactUs->phone}}" />
                            </div>
                        </div>
                        ...
                        <form action="{{ route('contact-us.update','orders') }}" method="post" autocomplete="off" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <textarea class="form-control"  name="note">{{$contactUs->note}}</textarea>
                                </div>
                            </div>
                            <div class="row">
