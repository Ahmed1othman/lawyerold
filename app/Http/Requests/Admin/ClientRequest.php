...
class ClientRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        switch ($this->method()) {
            ...
            case 'POST': {
                    return [
                        'name' => 'required|string|min:2|max:150|unique:clients,name->en',
                        'name_ar' => 'required|string|min:2|max:150|:clients,name->ar',
            ...
            case 'PUT': {
                    return [
                        'name' => 'required|string|min:2|max:150|unique:clients,name->en'. $this->id,
                        'name_ar' => 'required|string|min:2|max:150|unique:clients,name->ar'. $this->id,
